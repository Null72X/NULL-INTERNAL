namespace Client
{
    ...
    {
        public static string AimbotMode = "AimBotVisible";
        internal static Keys AimbotKey = Keys.LButton;
        internal static bool AimBot = false;
        internal static int Smooth = 30;
        internal static int AimFovCircle = 200;
        ...
        internal static bool FovNearMe = false;
        internal static bool SilentAim = false;
        internal static bool InfinitySkyler = false;
        internal static bool SpeedTimer = false;
        internal static bool UnlimitedAmmo = false;
        internal static bool AimbotLegit = false;
        internal static bool SpeedJump = false;
        internal static bool MedkitRunning = false;
        internal static bool CameraHack = false;
        internal static bool UnderCamera = false;
        internal static bool FastMediKit = false;
        ...
        internal static bool ESPCornerbox = false;
